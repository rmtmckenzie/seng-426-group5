...
public class RegistrationJFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jPanel1.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Client Form"));

		jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"Financial Info",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Dialog", 0, 12), new java.awt.Color(51, 51,
						51))); // NOI18N
		...
		jTBankURLIP
				.setToolTipText("Please enter a Fully Qualified Domain Name, or an IP address.");
		...
		jPanel3.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Digital Certificate Info"));
				...
				.setHorizontalGroup(jPanel3Layout
						...
						.add(jPanel3Layout
								...
								.add(jPanel3Layout
										.createParallelGroup(
												org.jdesktop.layout.GroupLayout.LEADING)
										.add(jLabel8).add(jLabel6))
								.add(4, 4, 4)
								.add(jPanel3Layout
										.createParallelGroup(
												org.jdesktop.layout.GroupLayout.LEADING,
												false)
										.add(jCValidation, 0, 125,
												Short.MAX_VALUE).add(jTDCURLIP))
								.addContainerGap(
										org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)));
		jPanel3Layout
		...
		jPanel4.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Security Sittings"));
	...
	private void jBeWalletMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jBeWalletMouseClicked
		...
		if (!pathFlag) {
			int option = JOptionPane.showConfirmDialog(null,
					"E-Wallet already exists!\nDo you want to overwrite it?",
					"E-Wallet already exists", JOptionPane.YES_NO_OPTION);
	...
	private boolean tryCreateWallet() {
		...
		pathFlagLocal = new File(eWalletPath + File.separator + "In Coming")
				.mkdirs();
		pathFlagLocal &= new File(eWalletPath + File.separator + "Out going")
				.mkdirs();
		pathFlagLocal &= new File(eWalletPath + File.separator
				+ "Security Tools").mkdirs();
		pathFlagLocal &= new File(eWalletPath + File.separator + "My Cheques")
				.mkdirs();
		pathFlagLocal &= new File(eWalletPath + File.separator + "History")
				.mkdirs();
	...
	private void jBRFRegisterMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jBRFRegisterMouseClicked
		...
		if (checkForErrors(bankName, bankURL, clientName, accountNumber,
				digitalCIssuer, digitalCURL, userName, password,
				jTPassword2.getPassword())) {
			return;
		}
		...
		try {
			...
			Cipher cipher = AESCrypt.initializeCipher(AES128,
					AESCrypt.cypherType.ENCRYPT);
			InputStream in = new FileInputStream(eWalletPath + File.separator
					+ "Security Tools" + File.separator + "privateKey.key");
			...
			in.close();
			out.close();
			new File(eWalletPath + File.separator + "Security Tools"
					+ File.separator + "privateKey.key").delete();
			...
			EChequeClient client = new EChequeClient(8189,
					EChequeClient.MODE_REGISTER,
	...
	private boolean checkForErrors(String bankName, String bankURL,
		...
		if (bankName.matches(".*\\d.*")) {
			JOptionPane.showMessageDialog(null,
					"Bank Name cannot contain numbers", "User Error",
					JOptionPane.ERROR_MESSAGE);
			return true;
		}
		if (bankURL.length() == 0) {
		...
		if (clientName.matches(".*\\d.*")) {
			JOptionPane.showMessageDialog(null,
					"Client Name cannot contain numbers", "User Error",
					JOptionPane.ERROR_MESSAGE);
			return true;
		}
		...
		if (digitalCIssuer.matches(".*\\d.*")) {
			JOptionPane.showMessageDialog(null,
					"Digital Certificate Issuer cannot contain numbers",
					"User Error", JOptionPane.ERROR_MESSAGE);
			return true;
		}
