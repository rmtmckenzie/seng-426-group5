...
public class RegistrationJFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jPanel1.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Client Form",
		...
		jPanel3.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Digital Certificate Info",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(
								0, 0, 0)));
		...
		jPanel4.setBorder(javax.swing.BorderFactory
				.createTitledBorder(null, "Security Sittings",
						javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
						javax.swing.border.TitledBorder.DEFAULT_POSITION,
						new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(
								0, 0, 0)));
						...
						.add(jPanel4Layout
								...
								.add(jPanel4Layout
										...
										.add(jTUserName,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
												125, Short.MAX_VALUE))
								.add(57, 57, 57).add(jBeWallet).add(22, 22, 22)));
		jPanel4Layout
		...
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 458) / 2, (screenSize.height - 482) / 2,
				458, 482);
    ...
    private void jBeWalletMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jBeWalletMouseClicked
        ...
        pathFlag = new File(eWalletPath + System.lineSeparator() + "In Coming").mkdirs();
        if (pathFlag) {
            pathFlag = new File(eWalletPath + System.lineSeparator() + "Out going").mkdirs();
        }
        if (pathFlag) {
            pathFlag = new File(eWalletPath + System.lineSeparator() + "Security Tools").mkdirs();
        }
        if (pathFlag) {
            pathFlag = new File(eWalletPath + "/My Cheques").mkdirs();
        }
        if (pathFlag) {
            pathFlag = new File(eWalletPath + "/History").mkdirs();
        }
    ...
    private void jBRFRegisterMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jBRFRegisterMouseClicked
        ...
        try {
            ...
            outObj = new ObjectOutputStream(new FileOutputStream(eWalletPath
                    + System.lineSeparator() + "Security Tools" 
                    + System.lineSeparator() +  "privateKey.key"));
            ...
            OutputStream out = new FileOutputStream(eWalletPath
                    + System.lineSeparator() + "Security Tools"
                    + System.lineSeparator() + "Private Key.key");

            // encrypt the private key with the AES key and delete the plain key
            aesCrypt.crypt(in, out, cipher);
            in.close();
            out.close();
            File control = new File(eWalletPath + System.lineSeparator()
                    + "Security Tools" + System.lineSeparator() 
                    + "privateKey.key");
            control.delete();
            ...
            dcIO.SaveDC(dcObj, eWalletPath + System.lineSeparator() 
                    + "Security Tools" + System.lineSeparator() 
            ...
            JOptionPane.showMessageDialog(null,
                    "Access Disk Media is not allowed", "System Error",
                    JOptionPane.ERROR_MESSAGE);
        } catch (NoSuchAlgorithmException exp) {
            JOptionPane.showMessageDialog(null,
                    "ONE of your Java Securiy Feature not available",
